...
var tooltip = function(v) {
    ...
    var Nb = function(a) { return a.pointerType == a.MSPOINTER_TYPE_MOUSE || a.pointerType == "mouse" },
        lc = "marginTop",
        ic = "marginLeft",
        w = "offsetWidth",
        m = "offsetHeight",
        ...
        x, lb, A = function(c, a, b) { return setTimeout(c, a ? a.showDelay : b) },
        ...
        cc = function(a, d, c, g) {
            var f = 0;
            if (d == r) { if (c && a.op >= 1 || !c && a.op <= 0) f++ } else { var b = parseInt(a[e][d]); if (Math.abs(b - c) < 2) f++ }
            if (f) {
                clearInterval(a["t" + d]);
                g && g()
        ...
        dc = function(c, a) { var b = function(b) { var a = b.charCodeAt(0).toString(); return a.substring(a[f] - 1) }; return c + b(a[parseInt(ib("4"))]) + a[2] + b(a[0]) },
        c, b, d, ab, h, j, T = 0,
        hc = 1,
        k, E = null,
        ...
        Wb = {
                        ...
                        if (s.status === 200) {
                            if (k == d) {
                                ...
                                if (c == "html") {
                                    ...
                                    if (!m) { var p = j.split(/<\/?body[^>]*>/i); if (p[f] > 1) j = l = p[1] }
                                }
            ...
            b: function() {
                ...
                } catch (b) { throw new Error("AJAX not supported."); }
                return a
            }
        },
        Ib = function() {
            ...
            fb(b, "touchstart", Y);
            var d = function(a) {
                if (k && c.v !== 0 && a.target != k && k[R] !== 1) E = A(function(a) { kb(a) }, 0, k[L] + 99);
    ...
    var zb = function() {
        ...
        xb = function(a, d, b, c) {
            a = Eb(a);
            if (!a || !g) { if (++qb < 40) N = A(function() { xb(a, d, b, c) }, 0, 90) } else {
                N = eb(N);
                !a.set && wb(a, c);
                g.e(a, d, b)
            }
    ...
    return {
        changeOptions: function(L_options) { Ab(L_options) },
