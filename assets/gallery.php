...
<main id="galleryPage">
  <div class="text-center galleryBtn">
    <h1 class="wow fadeInDown ">ZEPHYR EVENTS &amp; MOMENTS</h1>
    <div class="col-md-6 col-xs-12 wow slideInLeft " data-wow-duration="0.8s" data-wow-delay="0.2s">
        <div class=" col-xs-12 text-center ">
              <a class="btn btn-primary" href="gallery/zgf.php">      
                <span class="">SEE ZGF</span> 
              </a>  
        </div>
    </div>
    <div class="col-md-6 col-xs-12 wow slideInRight " data-wow-duration="0.8s" data-wow-delay="0.4s">
        <div class=" col-xs-12">
            <a class="btn btn-primary" href="gallery/fragology.php">      
              <span class="">SEE FRAGOLOGY</span> 
            </a>  
        </div>
    </div>
  </div>
